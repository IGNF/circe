...
static const std::string uiFormatText[UF_COUNT] =
{
    ...
    "",
    "longitude latitude",
    "longitude latitude orthometric-height",
    "id longitude latitude",
    "id longitude latitude orthometric-height",
    "",
    "latitude longitude",
    "latitude longitude orthometric-height",
    "id latitude longitude",
    "id latitude longitude orthometric-height",
    "",
    ...
    "id easting northing",
    "id easting northing orthometric-height",
    "",
    "northing easting",
    "northing easting orthometric-height",
    "id northing easting",
    "id northing easting orthometric-height",
    "",
